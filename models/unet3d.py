# from https://github.com/JielongZ/3D-UNet-PyTorch-Implementation
import numpy as np
import torch
...
class ConvBlock(nn.Module):
    def __init__(self, in_channels, out_channels, k_size=3, stride=1, padding=1):
        ...
        self.batch_norm = normalization(out_channels) #nn.BatchNorm3d(num_features=out_channels)
...
class UnetModel(nn.Module):
    ...
    def __init__(self, config):
        ...
        in_channels = len(config.dataset.features)
