...
#         intermediate_channel = max(max_channel//2, 64)

#         self.encoder_pool1 = Pool3DBlock(2)
#         self.encoder_res1 = Res3DBlock(64, intermediate_channel)
...
#         self.decoder_upsample1 = Upsample3DBlock(intermediate_channel, 64, 2, 2)

#         self.skip_res1 = Res3DBlock(64, 64)
